...
require (
	...
	github.com/openmcp-project/control-plane-operator v0.1.8
	github.com/openmcp-project/controller-utils v0.9.0
	github.com/openmcp-project/mcp-operator/api v0.29.0
...
require (
	...
	github.com/gardener/landscaper/apis v0.134.0 // indirect
