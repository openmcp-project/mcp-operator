...
require (
	...
	github.tools.sap/CoLa/controller-utils v0.3.0
	github.tools.sap/CoLa/mcp-operator/api v0.26.0
	github.tools.sap/cloud-orchestration/control-plane-operator v0.1.2
	github.tools.sap/cloud-orchestration/controller-utils v0.0.4
	github.tools.sap/cloud-orchestration/controller-utils/api v0.0.4
...
require (
	...
	github.com/crossplane/crossplane v1.17.2 // indirect
	...
	github.com/gardener/landscaper/apis v0.127.0 // indirect
