...
require (
	...
	github.com/gardener/landscaper-service v0.134.0
	...
	github.com/openmcp-project/mcp-operator/api v0.38.0
...
require (
	...
	github.com/gardener/landscaper/apis v0.140.0 // indirect
